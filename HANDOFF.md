...
- The latest non-live Windows acceptance report is `reports\reachops_acceptance\20260625_090334\acceptance_summary.json` on the Windows VM.
- The latest package check is `reports\reachops_acceptance\20260625_090334\delivery_package_check.json`, with `passed=true`, `status=ready_for_external_validation`, and `effective_pending_external_validation=2`.
