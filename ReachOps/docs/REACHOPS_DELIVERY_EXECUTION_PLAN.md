...
- Non-live Windows acceptance wrote `reports\reachops_acceptance\20260625_092516\acceptance_summary.json` with status `ready_for_external_validation`.
...
- Full Windows acceptance proof on the Windows VM: `reports\reachops_acceptance\20260625_092516\live_acceptance_status_payload.json`, `reports\reachops_acceptance\20260625_092516\live_readiness_payload.json`, `reports\reachops_acceptance\20260625_092516\live_preflight_payload.json`, and `reports\reachops_acceptance\20260625_092516\activation_status_payload.json`.
- Live validation manifest now treats activation templates or inactive files as `有效激活状态文件` missing; file existence alone is not enough for Milestone 3 readiness.
