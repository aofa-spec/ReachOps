...
def run_web_local_api_architecture_fixture() -> dict:
    ...
    checks = {
        ...
        "p1_runtime_observation_ledger_contract": "CREATE TABLE IF NOT EXISTS campaign_runs" in growth_storage and "CREATE TABLE IF NOT EXISTS candidate_observations" in growth_storage and "CREATE TABLE IF NOT EXISTS evidence_artifacts" in growth_storage and "CREATE TABLE IF NOT EXISTS lead_decisions" in growth_storage and "legacy rows must not be assigned a fabricated run_id" in growth_storage and "runtime_traceability_summary" in growth_storage and "legacy_run_id_fabricated\": False" in growth_storage and "record_candidate_observation" in growth_storage and "record_evidence_artifact" in growth_storage and "record_lead_decision" in growth_storage and "decision_version" in growth_storage and "list_lead_decisions" in growth_storage and "create_campaign_run" in growth_task_router and "bind_collection_batch_run" in growth_task_router and "active_run_id" in growth_task_router and "build_report(campaign_id=campaign_id, run_id=active_run_id, batch_id=batch_id)" in growth_task_router and "record_candidate_observation" in operation_lead_manager and "record_evidence_artifact" in operation_lead_manager and "record_lead_decision" in operation_lead_manager and "reachops.runtime_traceability_report.v1" in growth_reporter and "_resolve_runtime_scope" in growth_reporter and "runtime_traceability" in growth_reporter and "lead_decision_lineage_schema_version" in growth_reporter and "_lead_decisions.csv" in growth_reporter and "legacy_rows_preserved" in growth_reporter and "\"run_id\"" in growth_reporter and "\"campaign_id\"" in growth_reporter and "start_contract_current_evidence_complete" in (ROOT_DIR / "tools" / "reachops_goal_delivery_runner.py").read_text(encoding="utf-8"),
        "encrypted_backup_restore_contract": "reachops.backup.v1" in backup_contract and ".reachops-backup" in backup_contract and "pbkdf2_hmac" in backup_contract and "hmac_sha256" in backup_contract and "preview_backup" in backup_contract and "restore_backup" in backup_contract and "rollback_on_failure" in backup_contract and "secret_or_activation_state_excluded" in backup_contract and "credential_manager_secrets_never_exported" in backup_contract and "ixbrowser_cookies_sessions_and_login_state_never_exported" in backup_contract and "\"full\"" in backup_contract and "include_evidence_files" in backup_contract and "selected_evidence_file" in backup_contract and "full_backup_includes_only_selected_evidence_files" in backup_contract and "customer_data_uploaded\": False" in backup_contract,
