...
def run_web_local_api_architecture_fixture() -> dict:
    ...
    checks = {
        ...
        "acceptance_summary_verifies_authorization_handoff_payload": "authorization_handoff_json_invalid" in acceptance_summary_verifier and "authorization_handoff_json_mismatch" in acceptance_summary_verifier and '"readiness_status"' in acceptance_summary_verifier,
