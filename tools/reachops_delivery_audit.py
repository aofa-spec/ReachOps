...
def run_web_local_api_architecture_fixture() -> dict:
    ...
    checks = {
        ...
        "web_operator_outreach_rows_explain_language_gate": "language_gate_summary" in web_ui and "human_language_gate_summary" in web_ui and "语言冲突阻断" in web_ui and "语言需人工确认" in web_ui and "冲突解除前不能真实提交" in web_ui and "row.language_gate_summary || row.risk_gate_summary" in web_ui,
