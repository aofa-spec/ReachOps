...
"""
    ...
    return {
        ...
        "account_gate_debug": {
            "client_delivery_only_start_disabled": payload.get("clientDeliveryOnlyGateStartDisabled"),
            ...
            "account_repair_stale_delta": payload.get("accountRepairStaleStartRequestDelta"),
            "account_repair_stale_title": payload.get("accountRepairStaleStartTitle"),
            "account_repair_stale_blockers": payload.get("accountRepairStaleBlockers"),
            "account_repair_stale_body": payload.get("accountRepairStaleStartBody"),
            "account_repair_stale_actions": payload.get("accountRepairStaleStartActions"),
            "different_group_start_disabled": payload.get("accountGateDifferentGroupStartDisabled"),
            "same_group_start_disabled_after_switch": payload.get("accountGateSameGroupStartDisabledAfterSwitch"),
            "account_gate_start_request_delta": payload.get("accountGateStartRequestDelta"),
            ...
            "account_repair_apply_actions_after_click": payload.get("accountRepairApplyActionsAfterClick"),
            "account_repair_auto_confirmed_after_apply": payload.get("accountRepairAutoConfirmedAfterApply"),
            "repair_confirmed_start_disabled": payload.get("accountRepairConfirmedStartDisabled"),
            "repair_confirmed_start_title": payload.get("accountRepairConfirmedStartTitle"),
            "repair_confirm_cleared_on_group_switch": payload.get("accountRepairConfirmClearedOnGroupSwitch"),
        },
    }
