...
const responses = {{
  ...
  '/api/final-status': {{status:'blocked', final_delivery_ready:false, no_browser_started:true, no_submit:true, delivery_boundary:{{schema_version:'reachops.delivery_boundary.v1', status:'local_capability_ready_final_pending', local_product_capability_ready:true, product_capability_ready:true, product_development_ready:true, final_delivery_ready:false, external_validation_pending:true, windows_final_artifacts_pending:true, pending_scopes:['external_authorized_execution','windows_final_artifacts','commercial_issue_closure'], boundary_note:'本地产品能力 ready 只证明自治链路闭环；final_delivery_ready=true 才代表真实授权执行和最终客户端交付完成。'}}, delivery_boundary_status:'local_capability_ready_final_pending', local_product_capability_ready:true, product_capability_ready:true, product_development_ready:true, external_validation_pending:true, windows_final_artifacts_pending:true, pending_scopes:['external_authorized_execution','windows_final_artifacts','commercial_issue_closure'], report_path:'/tmp/latest_live_acceptance_readiness.md', json_report_path:'/tmp/latest_live_acceptance_readiness.json', handoff_bundle_path:'/tmp/latest_reachops_authorization_handoff.zip', handoff_bundle_size:7631, handoff_bundle_verification:{{status:'passed', passed:true, failures:[], forbidden_files:[]}}, operator_commands:['powershell -ExecutionPolicy Bypass -File tools\\\\init_reachops_acceptance_inputs_windows.ps1 -Json','python tools\\\\reachops_live_acceptance_status.py --local-inputs-path tools\\\\reachops_acceptance_inputs.local.ps1 --write-report --json-report-path --json'], local_inputs:{{field_status:{{ProfileIds:{{ready:false,state:'placeholder',required_action:'替换 ProfileIds 的占位值。'}},CommentVideoUrl:{{ready:false,state:'placeholder',required_action:'替换 CommentVideoUrl 的占位值。'}},FollowProfileUrl:{{ready:false,state:'placeholder',required_action:'替换 FollowProfileUrl 的占位值。'}},DmProfileUrl:{{ready:false,state:'placeholder',required_action:'替换 DmProfileUrl 的占位值。'}},TargetUsername:{{ready:false,state:'placeholder',required_action:'替换 TargetUsername 的占位值。'}},ActivationStatusPath:{{ready:false,state:'placeholder',required_action:'替换 ActivationStatusPath 的占位值。'}},ConfirmAuthorizedTargets:{{ready:false,state:'authorization_not_confirmed',required_action:'确认所有 TikTok 目标已授权后，将 ConfirmAuthorizedTargets 设置为 $true。'}}}}}}, live_validation:{{status:'blocked', selected_profile_ids:[], selected_profile_count:0, missing_inputs:['ixBrowser 数字 Profile ID','已授权 TikTok 视频链接'], blocking_summary:{{profile_ready:false, target_ready:false, activation_ready:false, authorization_confirmed:false, next_blocking_item:'ixBrowser 数字 Profile ID'}}}}, mvp_acceptance:{{status:'mvp_accepted_external_pending', mvp_local_ready:true, final_delivery_ready:false, failed_checks:[], path:'/tmp/latest_mvp_acceptance_summary.json'}}, goal_delivery:{{status:'local_mvp_accepted_final_pending', local_mvp_ready:true, windows_build_ready:true, final_delivery_ready:false, delivery_boundary:{{summary:'本地 MVP 和客户端门禁已可验收；整项目最终交付仍未完成。', local_mvp_scope_ready:true, client_gate_scope_ready:true, windows_build_input_scope_ready:true, overall_final_delivery_scope_ready:false, client_gate_final_delivery_ready_is_not_overall_final_delivery:true, blocking_scopes:['windows_final_artifacts','external_authorized_execution','commercial_issue_closure']}}, final_delivery_blockers:[{{scope:'external_authorized_execution', status:'ready_for_external_validation', required_evidence:['授权 TikTok 目标','comment_visible_confirmed=true'], next_action:'完成授权真实触达验收，确保 goal_status.status=passed 且 pending_external_validation=[]。'}},{{scope:'client_delivery_gate', status:'blocked_by_accounts', account_support_handoff:{{schema_version:'reachops.account_support_handoff.v1', status:'stale_repair_apply', priority_action:'manually_repair_or_replace_accounts', profile_group:'United States', repair_plan:{{available:true, profile_count:20, event_count:25, auto_apply_profile_count:0, non_auto_error_codes:['PROFILE_PREFLIGHT_TIMEOUT']}}, impacted_accounts:{{error_groups:[{{error:'PROFILE_PREFLIGHT_TIMEOUT', count:20, profile_ids_sample:['5897','18430']}},{{error:'PAGE_OPEN_FAILED', count:5, profile_ids_sample:[]}}]}}, retest_commands:['python tools\\\\reachops_client_delivery_check.py --json','python tools\\\\reachops_goal_delivery_runner.py --json']}}}},{{scope:'windows_final_artifacts', status:'failed', required_artifacts:['dist\\\\ReachOps\\\\ReachOps.exe','reports\\\\reachops_acceptance\\\\acceptance_summary.json'], next_action:'在 Windows 实机生成 exe、installer、update manifest 和通过的 acceptance_summary.json，然后复跑 tools\\\\reachops_delivery_package_check.py --json。'}},{{scope:'commercial_issue_closure', status:'passed_with_external_acceptance_pending', required_evidence:['Issues #1-#7 closed','acceptance_criteria_external_pending=0'], next_action:'完成 Issues #1-#7 中仍标记 external_pending 的验收标准，并复跑 tools\\\\reachops_issue_closure_audit.py --json。'}}], deliverable_index:{{local_mvp_acceptance:{{ready:true}}, windows_final_package:{{ready:false}}, commercial_issue_closure:{{ready:false}}, final_acceptance_gate:{{ready:false}}}}, failed_checks:['goal_status:passed','client_delivery:final_ready','delivery_package:passed','commercial_issue_closure:closed'], blockers:[{{scope:'windows_final_artifacts', status:'failed', remediation_plan:{{commands:['powershell -ExecutionPolicy Bypass -File tools\\\\build_reachops_windows.ps1','powershell -ExecutionPolicy Bypass -File tools\\\\run_reachops_acceptance_windows.ps1 -RunLiveSubmit -ConfirmAuthorizedTargets','python tools\\\\reachops_final_acceptance_gate.py --json']}}}},{{scope:'commercial_issue_closure', status:'passed_with_external_acceptance_pending'}}], windows_package_preflight:{{status:'ready_for_windows_build', ready_for_windows_build:true, final_delivery_ready:false, missing_final_artifacts:['exe','installer','manifest','acceptance_summary'], default_build_requires_installer:true, skip_installer_is_non_final:true, preflight_report_path:'/tmp/windows_package_preflight.json'}}, path:'/tmp/latest_goal_delivery_report.json', summary_path:'/tmp/latest_goal_delivery_summary.md'}}, final_delivery_evidence_plan:{{schema_version:'reachops.final_delivery_evidence_plan.v1', ready:false, pending_scopes:['external_authorized_execution','windows_final_artifacts','commercial_issue_closure'], items:[{{scope:'external_authorized_execution', status:'ready_for_external_validation', required_evidence:['授权 TikTok 目标','comment_visible_confirmed=true'], proof_fields:['goal_status.pending_external_validation=[]'], commands:['python tools\\\\reachops_goal_status_report.py --strict-external --json']}},{{scope:'windows_final_artifacts', status:'failed', required_artifacts:['dist\\\\ReachOps\\\\ReachOps.exe','reports\\\\reachops_acceptance\\\\acceptance_summary.json'], proof_fields:['delivery_package.final_delivery_ready=true'], commands:['python tools\\\\reachops_delivery_package_check.py --json']}},{{scope:'commercial_issue_closure', status:'passed_with_external_acceptance_pending', required_evidence:['Issues #1-#7 closed'], proof_fields:['issue_closure.summary.acceptance_criteria_external_pending=0','issue_closure.summary.external_pending_count=0'], commands:['python tools\\\\reachops_issue_closure_audit.py --json']}}]}}, failed_checks:['live_validation:inputs','delivery_package:passed','final_acceptance_gate:passed','commercial_issue_closure:closed'], blocking_plan:[{{stage:'授权输入', status:'blocked', blockers:['已授权 TikTok 视频链接'], actions:['运行 tools\\\\init_reachops_acceptance_inputs_windows.ps1 生成本地验收输入文件。','填入已授权 TikTok 视频链接 CommentVideoUrl。']}},{{stage:'激活状态', status:'blocked', blockers:['激活状态未 ready，不能进入真实提交验收。'], actions:['生成或放置真实激活状态文件，并设置 ActivationStatusPath。']}},{{stage:'Windows交付包', status:'blocked', blockers:['Windows 交付包未达到 final_delivery_ready=true。'], actions:['在 Windows 实机生成 exe、installer、manifest 和 acceptance_summary.json 后复跑 package check。']}},{{stage:'最终门禁', status:'blocked', blockers:['final acceptance gate 未达到 status=passed 且 final_delivery_ready=true。'], actions:['运行 tools\\\\reachops_final_acceptance_gate.py --json 并确认 status=passed、final_delivery_ready=true。']}}], blocked_reasons:['Windows 交付包未达到 final_delivery_ready=true。','Issues #1-#7 商业交付闭环未完成。'], next_required_actions:['运行 tools\\\\init_reachops_acceptance_inputs_windows.ps1 生成本地验收输入文件，然后填入已授权 TikTok 目标和激活状态路径。','完成 Issues #1-#7 外部验收并复跑 issue closure audit。'], verification_commands:['python tools\\\\reachops_client_delivery_check.py --json','python tools\\\\reachops_goal_delivery_runner.py --json','python tools\\\\reachops_delivery_package_check.py --json','python tools\\\\reachops_issue_closure_audit.py --json','python tools\\\\reachops_final_acceptance_gate.py --json']}},
...
async function fetchMock(url, options = {{}}) {{
  ...
  if (url === '/api/goal-delivery-refresh') {{
    return {{ok:true, status:200, json: async () => ({{status:'local_mvp_accepted_final_pending', local_mvp_ready:true, windows_build_ready:true, final_delivery_ready:false, failed_checks:['delivery_package:passed','commercial_issue_closure:closed'], blockers:['windows_final_artifacts','commercial_issue_closure'], windows_package_preflight:{{status:'ready_for_windows_build', missing_final_artifacts:['exe','installer','manifest','acceptance_summary'], default_build_requires_installer:true, skip_installer_is_non_final:true}}}})}};
  }}
...
"""
    ...
    checks["hourglass_particles_are_bound_to_runtime_evidence"] = (
        ...
        and "title=\"交付边界：3\"" in hourglass_particles
    )
    ...
    checks["final_status_shows_goal_blocking_scope_count"] = "目标阻断范围：3项" in str(payload.get("finalStatusActions") or "") and "windows_final_artifacts" in str(payload.get("finalStatusActions") or "") and "commercial_issue_closure" in str(payload.get("finalStatusActions") or "")
    ...
    checks["final_status_shows_final_delivery_blockers"] = "最终阻断：external_authorized_execution" in str(payload.get("finalStatusActions") or "") and "最终阻断：windows_final_artifacts" in str(payload.get("finalStatusActions") or "") and "最终阻断：commercial_issue_closure" in str(payload.get("finalStatusActions") or "")
    checks["final_status_shows_account_support_handoff"] = "账号支持交接：stale_repair_apply / manually_repair_or_replace_accounts / 分组=United States" in str(payload.get("finalStatusActions") or "") and "非自动错误=PROFILE_PREFLIGHT_TIMEOUT" in str(payload.get("finalStatusActions") or "") and "账号复测命令：python tools\\reachops_client_delivery_check.py --json" in str(payload.get("finalStatusActions") or "")
    ...
    checks["final_status_shows_final_delivery_evidence_plan"] = "证据计划：reachops.final_delivery_evidence_plan.v1" in str(payload.get("finalStatusActions") or "") and "证据项：external_authorized_execution" in str(payload.get("finalStatusActions") or "") and "证据项：commercial_issue_closure" in str(payload.get("finalStatusActions") or "") and "验收字段：goal_status.pending_external_validation=[]" in str(payload.get("finalStatusActions") or "") and "验收字段：issue_closure.summary.acceptance_criteria_external_pending=0" in str(payload.get("finalStatusActions") or "") and "验收命令：python tools\\reachops_delivery_package_check.py --json" in str(payload.get("finalStatusActions") or "") and "验收命令：python tools\\reachops_issue_closure_audit.py --json" in str(payload.get("finalStatusActions") or "")
    ...
    checks["final_status_commands_visible_to_operator"] = "reachops_final_acceptance_gate.py" in str(payload.get("finalStatusCommands") or "") and "reachops_delivery_package_check.py" in str(payload.get("finalStatusCommands") or "") and "reachops_goal_delivery_runner.py" in str(payload.get("finalStatusCommands") or "") and "reachops_issue_closure_audit.py" in str(payload.get("finalStatusCommands") or "")
