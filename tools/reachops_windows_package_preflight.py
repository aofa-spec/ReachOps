...
REQUIRED_FILES = {
    ...
    "control_plane_audit": "tools/reachops_control_plane_audit.py",
    "issue_closure_audit": "tools/reachops_issue_closure_audit.py",
    ...
    "security_supply_chain_audit": "tools/reachops_security_supply_chain_audit.py",
    "start_contract_audit": "tools/reachops_start_contract_audit.py",
...
SCRIPT_EXPECTATIONS = {
    ...
    "tools/reachops_ci_release_baseline_audit.py": [
        "reachops.ci_release_baseline_audit.v1",
        "SUPPORTED_PYTHON",
        "SUPPORTED_WINDOWS_RUNNER",
        "python -m pip check",
    ...
    "tools/reachops_control_plane_audit.py": [
        "reachops.control_plane_audit.v1",
        "passed_with_external_control_plane_pending",
        ...
        "does_not_claim_server_side_rbac",
        "does_not_claim_non_tiktok_connector_ga",
    ],
    "tools/reachops_issue_closure_audit.py": [
        "reachops.issue_closure_audit.v1",
        "passed_with_external_acceptance_pending",
        "issues_total",
        "local_contracts_passed",
        "acceptance_criteria_total",
        "acceptance_criteria_local_passed",
        "acceptance_criteria_external_pending",
        "acceptance_criteria_unclassified",
        "does_not_claim_all_issues_closed",
        "closure_requires_external_validation",
    ...
    "tools/reachops_data_governance.py": [
        ...
        "verify_privacy_operation_audit",
        "reachops.privacy_operations.v1",
        "reachops.recovery_objectives.v1",
    ...
    "tools/reachops_security_supply_chain_audit.py": [
        "reachops.security_supply_chain_audit.v1",
        "reachops.entitlement_security_matrix.v1",
        "reachops.update_supply_chain_matrix.v1",
        ...
        "downgrade_without_rollback_blocked",
        "explicit_rollback_available",
    ],
    "tools/reachops_start_contract_audit.py": [
        "reachops.start_contract_audit.v1",
        "reachops.api_start_contract.v1",
        "target_required",
